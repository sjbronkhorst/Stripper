...
public class BucklingEquation {
    ...
    public BucklingDataPoint getBucklingData() {
        ...
        CoupledMatrix cKe = new CoupledMatrix(nodes.size(), model.getFourierTerms());
        CoupledMatrix cKg = new CoupledMatrix(nodes.size(), model.getFourierTerms());
