...
// Make the TableView editable
        ...
        setLengthBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Main.println("Model length has been set to " + Double.toString(Defaults.getBaseModel().getModelLength()));
...
//                }
                ...
                draw();
                Main.println("Thickness has been set");
            }
        });
...
//                }
        ...
        stripPropertyBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Main.println("Strip " + s.getStripId() + " properties :");
                Main.println("width = " + s.getStripWidth());
                Main.println("thickness = " + s.getStripThickness());
        ...
        stripRemoveBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (s != null) {
                    ...
                    Main.println("Strip " + s.getStripId() + " removed.");
                } else {
                    Main.println("ERROR : No nodes selected !");
                }
                draw();
        ...
        removeBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (n != null) {
                    ...
                    Main.println("Node " + n.getNodeId() + " removed.");
                } else {
                    Main.println("ERROR : No nodes selected !");
                }
                draw();
        ...
        nodeDofBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (n != null) {
                    ...
                    Main.println("Editing " + n.toString() + " DOF");
...
// Id column is non-editable
    ...
    public void addXCoordColumn(TableView<Node> table) {
        ...
        fNameCol.setOnEditStart(e -> {
            Main.println("Press Enter to save changes, Esc to cancel");
        });
        ...
        fNameCol.setOnEditCommit(e -> {
            ...
            Main.println("X-Coordinate changed for Node "
    ...
    public void addZCoordColumn(TableView<Node> table) {
        ...
        fNameCol.setOnEditCommit(e -> {
            ...
            Main.println("Z-Coordinate changed for Node "
                    + node.getNodeId() + " at row " + (row + 1) + " to " + e.getNewValue());
    ...
    public void addNode1Column(TableView<Strip> table) {
        ...
        fNameCol.setOnEditCommit(e -> {
            ...
            try {
                ...
                Main.println("First node changed for Strip "
                ...
                Main.println("New node id " + strip.getNode1().getNodeId());

                draw();
            } catch (Exception ex) {
                Main.println("Node not found, create it and try again");
            }
    ...
    public void addNode2Column(TableView<Strip> table) {
        ...
        fNameCol.setOnEditCommit(e -> {
            try {
                ...
                Main.println("Second node changed for Strip "
                        + strip.getStripId() + " at row " + (row + 1) + " to " + e.getNewValue());
                ...
                Main.println("New node id " + strip.getNode2().getNodeId());
    ...
    public void addThicknessColumn(TableView<Strip> table) {
        ...
        fNameCol.setOnEditCommit(e -> {
            try {
                ...
                Main.println("Thickness changed for Strip "
                        + strip.getStripId() + " at row " + (row + 1) + " to " + e.getNewValue());
